...
function clientCredentialsFlow(options) {
  ...
  if (!settings.clientId) {
      throw new Error('You must provide a clientId for client credentials flow');
  }

  if (!settings.clientSecret) {
      throw new Error('You must provide a clientSecret for client credentials flow');
  }

  if (!settings.redirectUri) {
      throw new Error('You must provide a redirectUri for client credentials flow');
  }
...
function refreshTokenFlow(options) {
  ...
  if (!settings.clientId) {
      throw new Error('You must provide a clientId for refresh token flow');
  }

  if (!settings.clientSecret) {
      throw new Error('You must provide a clientSecret for refresh token flow');
  }

  if (!settings.refreshToken) {
      throw new Error('You must provide a refreshToken for refresh token flow');
  }
